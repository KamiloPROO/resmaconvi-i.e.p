...
public class VerTodosReportesMenu extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ver_todos_reportes_menu);

        continuarVerRepor = findViewById(R.id.btnContinuarVerReportesTodos);

        anioVer = findViewById(R.id.idSpinnerAniosVerReportesTodos);
        periodoVer = findViewById(R.id.idSpinnerPeriodosVerReportesTodos);
        ...
        continuarVerRepor.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(anioVerSele.equals("Seleccionar Año")){
                    ...
                    Toast.makeText(VerTodosReportesMenu.this, "Seleccione un año", Toast.LENGTH_SHORT).show();

                }else{

                    Intent intent = new Intent( VerTodosReportesMenu.this, VerReportes.class );
                    intent.putExtra("anioVerTodos",anioVerSele);
                    intent.putExtra("periodoVerTodos",periodoVerSele);
